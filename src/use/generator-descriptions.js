const GENERATOR_DESCRIPTIONS = Object.freeze({
    ...
    WEEKEND: "Produces a 0 for each sample except those that lie on a weekend day (saturday or sunday) with the given <b>magnitude</b>.",
    MONTHLY: "Produces a 0 for each sample except those that lie on a new month with the given <b>magnitude</b>.",
    ...
    WAVE_PULSE: "Samples a pulse wave with the given <b>period</b>, <b>duration</b>, <b>offset</b> and .",
    WAVE_BARTLETT_PULSE: "Samples a pulse wave with the given <b>period</b>, <b>duration</b>, <b>offset</b> and .",
